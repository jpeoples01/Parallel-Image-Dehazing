__kernel void get_dark_channel(const int startThreadNum,
                               __global const half *r, __global const half *g,
                               __global const half *b, const int x_height,
                               const int x_width, int wnd,
                               __global half *darkChannel) {
...
__kernel void get_atmosphere(__global half *input, __global half *output,
                             int n) {
...
__kernel void get_transmission_estimate(__global const half *image,
                                        __global const half *atmosphere,
                                        __global half *trans_est, half omega,
                                        int m, int n) {
...
__kernel void get_radiance(__global const half *image,
                           __global const half *transmission,
                           __global const half *atmosphere,
                           __global half *radiance, int m, int n) {
